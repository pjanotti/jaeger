...
build-platform-binaries: build-agent build-collector build-query build-ingester build-relay build-all-in-one build-examples
...
docker-images-only:
	...
	for component in agent collector query ingester relay ; do \
